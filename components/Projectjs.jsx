            ...
            <div className="space-y-4 md:space-y-0  ">
               <div className="flex flex-col sm:flex-row md:gap-8 sm:gap-2 w-[320px] h-[410px] sm:w-full  sm:justify-center sm:items-center  sm:bg-inherit sm:shadow-none bg-white rounded-[10px] shadow-lg">
                  ...
                  <div className="flex flex-col md:items-start  ">
                     ...
                     <p className="text-center text-sm font-light sm:text-left sm:w-[300px] px-8 mb-4 lg:mb-12 md:mb-6 lg:text-xl md:text-base md:px-0 md:text-left lg:w-[500px] md:w-[350px]">
                        Crafted a high-performance, responsive Skin and Hair Clinic website using
                        Next.js and Tailwind CSS. Integrated Google Analytics for data-driven
                        insights.
                     </p>
               ...
               <div className="flex flex-col sm:flex-row md:gap-8 sm:gap-2 w-[320px] h-[410px] sm:w-full  sm:justify-center lg:items-center sm:items-start md:items-start sm:bg-inherit sm:shadow-none bg-white rounded-[10px] shadow-lg">
                  ...
                  <div className="flex flex-col md:items-start  ">
                     ...
                     <p className="text-center text-sm font-light sm:text-left sm:w-[300px] px-8 mb-4 lg:mb-12 md:mb-6 lg:text-xl md:text-base md:px-0 md:text-left lg:w-[500px] md:w-[350px]">
                        Crafted a responsive web app in React.js, utilizing the REST Countries API
                        to showcase comprehensive country data, offering users an informative and
                        engaging experience
                     </p>
                     <div className="flex gap-6 justify-center items-center md:justify-start">
                        <Image src="/images/goto.svg" width={32} height={42} alt="Link Icon" />
